...
sudo apt-get -y install php7.0-fpm php7.0-cli php7.0-common libapache2-mod-php7.0 php7.0-mcrypt php7.0-mysql php5-mysqlnd
...
wget https://laterraform1.blob.core.windows.net/vhds/demo.php -O /var/www/html/demo.php
